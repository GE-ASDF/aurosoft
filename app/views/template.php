...
<body data-theme="dark">
    <div class="container">
        ...
        <div id="main-content">
            ...
            <?php extendss("_partials.SideMenu",['active' => isset($this->active) ? $this->active:'']); ?>
            <main id="main">
                <div id="main-header">
                    <button class="btn btn-main-purple rounded"><i class="bi bi-calendar-event"></i> Grade</button>
                    <button class="btn btn-purple-dark rounded"><i class="bi bi-cash-stack"></i> Caixa</button>
                </div>
                <div id="main-content-views" class="">
                    <div class="text-white mt-4 mb-4">
                        <span>Seu caixa: R$ 0,00</span>
                    </div>
                    <div>
    ...
    <script type="module" src="<?= asset("assets/js/close-btns.js") ?>"></script>
</body>
</html>